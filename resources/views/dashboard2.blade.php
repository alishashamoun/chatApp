                                    ...
                                    <div class="col-8">
                                        ...
                                        <p class="mb-0 text-muted">
                                            <span class="text-success me-2"><i
                                                    class="mdi mdi-arrow-top-right text-success"></i>+ 12%</span>Last month
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-8">
                                        ...
                                        <p class="mb-0 text-muted">
                                            <span class="text-danger me-2"><i
                                                    class="mdi mdi-arrow-bottom-left text-danger"></i>- 25%</span>Last month
                                        </p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <p class="mb-0 text-muted">
                                            <span class="text-success me-2"><i
                                                    class="mdi mdi-arrow-top-right text-success"></i> + 45%</span>last month
                                        </p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <p class="mb-0 text-muted">
                                            <span class="text-success me-2"><i
                                                    class="mdi mdi-arrow-top-right text-success"></i> + 25%</span>last month
                                        </p>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div
                                                                class="p-1 me-3 align-items-center justify-content-center d-flex">
